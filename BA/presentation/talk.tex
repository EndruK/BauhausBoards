...
\begin{frame}{Lösung}
  ...
  Anbringung von digitalen Türschildern
    ...
    \begin{itemize}
      ...
      \item Erhalt von Mitteilungen ohne vor Ort zu sein
...
\begin{frame}{Auswertung}
  ...
  \note<2>{
      ...
      \item Ausreichend Feedback durch Interviews
    \end{itemize}
  }
\end{frame}
  ...
  \begin{columns}
    ...
    \visible<2> {
      \begin{column}[t]{0.49\textwidth}
        ...
        \includegraphics[width=0.49\textwidth]{message_ex}
      \end{column}
    }
  \end{columns}
  \note<1-2>{
...
\begin{frame}{Studienergebnisse}
  ...
  \note<1>{
    \begin{itemize}
      \item als Ergebnis: gewisse Vor- / Nachteile
    \end{itemize}
  }
  \note<2>{
    \begin{itemize}
