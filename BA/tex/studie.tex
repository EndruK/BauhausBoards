...
\end{figure}
\\
Bevor die Studie begann, wurden die Boards angebracht \abb{img:StudieAufgehaengesBoard}.
...
\begin{table}[h!]
  ...
  \begin{tabularx}{\textwidth}{|X|X|c|}
    % \hline
    % \textbf{Nachrichten mit Inhalt (12)} & \textbf{Spaßnachrichten (30)}\\\hline
    % einfach nur Hallo: 6 & Zeichnungen: 16\\\hline
    % Frage nach Essen: 3  & Vandalismus: 8\\\hline
    % Information / Frage zu Meeting: 2 & undefinierbar: 6\\\hline
    % Information an Besitzer: 1 & \\\hline
    \hline
...
% , da sie bei bestimmten Nachrichten nur raten konnten, wer sie erstellt hatte.
\\
...
Einige Tester nutzten diese Funktion auch, um die aktuelle Arbeit zu beschreiben \abb{img:StudieExampleContent}.
...
% Dieser eine wollte jedoch nicht seine privaten Twittermeldungen in der Universität präsentieren.
\\
\\
...
\\
% \\\todotext{hier noch eine kleine Überleitung}\\
...
% \\
% Diese Werte deckten sich im wesentlichen mit dem Ergebnis der Interviews.
% \\\todotext{hier noch ein wenig mehr zur Überdeckung}
