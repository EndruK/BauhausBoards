...
Es ging darum herauszufinden, wofür die Besucher die Nachrichtenfunktion genutzt haben.
\\
...
Ein paar Nutzer wurden gefragt, ob sie mit dem Ersteller der Nachricht essen gehen wollten oder wurden auf ihren angezeigten Inhalt angesprochen.
...
Andere meinten, Besucher könnten sie per per Post-It-Zetteln oder Klopfen an ihrer Tür erreichen.
\\
Für die Kommunikation untereinander gaben einige an, Telefon, SMS oder Instant-Messenger zu nutzen.
\\
Auf die Frage, wie schnell die Testnutzer ihre Nachrichten gelesen haben, meinten alle (bis auf einen), dass sie direkt die Mail erhalten und auf den enthaltenen Link geklickt haben.
...
Da mit dem System Zeichnungen verschickt werden konnten meinte ein Testnutzer darauf, dass es eine persönliche Note verschafft: ``Die Zeichnungen machen es anders''.
Die anderen empfanden es nicht viel anderes als eine normale Email und demnach gut.
Es wurde besonders gut aufgenommen, dass die Tester von Besuchern über das System angesprochen werden können, wenn sie sich derzeit nicht im Büro aufhielten und die Besucher dafür nicht extra ein eigenes Gerät benötigten.
\\
...
Ich fragte die Testnutzer, ob sie in der Laufzeit der Studie einem anderen Nutzer eine Nachricht geschrieben hatten.
Die meisten hatten jedoch nur die Besitzerrolle wahrgenommen, da sie entweder keine Zeit hatten jemanden eine Nachricht zu schreiben oder persönlich mit diesen Personen redeten.
...
Von einigen Nutzern wurde dieses Feature auch genutzt, um die aktuelle Arbeit zu beschreiben. Ein Nutzer meinte dazu: ``um von außen einen schnellen Eindruck zu gewähren, was ich mache''.
\\
Einige Tester nutzten diese Funktion zum Anzeigen ihres Status, obwohl es dafür eine extra Funktion gab.
\\
...
Ein Nutzer meinte, der Editor zum Erzeugen von Inhalt würde vollkommen ausreichen und die Hintergrundschicht sollte maximal als Poweruser\footnote{ein Poweruser ist ein Nutzer, der deutlich mehr Kenntnisse über das System hat, als normale Nutzer}-Funktion angeboten werden, wobei diese über die Interaktivität des Hintergrunds selber entscheiden sollen.
\\
Leider nutzte keiner der Tester die Twitterfunktion.
Das lag daran, dass alle Tester, bis auf einen, keinen Twitteraccount besaßen.
Dieser wollte jedoch nicht seine privaten Twittermeldungen in der Universität präsentieren.
\\
Einige Tester fanden diesen Ansatz der Informationsdarbietung interessant, da es eine neue Technologie war und man damit sogar bewegten Inhalt erstellen konnte.
\\
Leider gab es auch Nutzer, die das Feature gar nicht nutzten.
...
Nur ein Nutzer gab seinen Status beim Verlassen des Raumes am Board an, die anderen taten dies an ihren PC's.
\\
...
\\
Der Status wurde von den meisten Nutzern üblicherweise vor dem Verlassen des Büros geändert, um anzugeben, dass er zum Essen oder zum Meeting unterwegs ist.
\\
...
\\
Zudem sollte der durchschnittliche Klickaufwand reduziert werden, damit Funktionen sich schneller durchführen lassen.
\\
...
\\
Außerdem waren einige Nutzer nicht mit dem zeitlichen Wechsel der Nutzer einverstanden.
...
Fast alle Benutzer meinten, dass sehr gut war, dynamischen Inhalt erstellen zu können und dass sie über Nachrichten informiert werden.
...
\\
Als Nachteil wurde die Tatsache angesehen, dass die kontinuierlich Energie verbrauchen und sie teurer als Post-It's sind.
...
Zu jeder Frage gab es 7 Möglichkeiten zum ankreuzen. Sie gingen von -3 (unattraktiv) bis 3 (attraktiv).
...
\\
Da Bauhausbaords ein neues System für die Testnutzer war, ist die Attraktivität positiv annähernd bei 1 und daher positiv.
\\
...
% FAZIT
% dauer der Studie zu kurz (Wenn nächste Studie: länger, damit in arbeitsprozess übergehen kann)
% teilweise zu viele funktionen
% manche funktionen sollten leichter gemacht werden
% gut zur Informationspräsentation + gifs
% gut für Kommunikation zwischen Gästen und Besitzern
