...
\\
Wenn ein Client die Adresse des Servers aufruft generiert der Webserver die Webseite und sendet sie mit allen benötigten Funktionen an den Client. Der Client kommuniziert danach nur durch CRUD Interaktionen mit dem Server.
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.8\textwidth]{./img/Systemaufbau.png}
  \caption{Bauhausboards - Grober Systemaufbau}
  \label{img:Systemaufbau}
\end{figure}
% PaperJS als Editorgrundlage
