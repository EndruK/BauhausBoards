...
\begin{itemize}
  ...
  \item Anheften Bildern oder Zettel per Magnet
...
\\
\\
In Abb. \ref{img:Interface} wird der Aufbau der Seitenstruktur mit Hauptansicht (Main View) und Benutzer-Backend (User Backend) dargestellt.
...
% \end{figure}
\\
Der Datenbankentwurf \abb{img:ER01} beinhaltete 6 Objektklassen, dargestellt als Tabellen. Um alle Objekte eindeutig beschreiben zu können, wurde in jeder Tabelle eine ID als Primärschlüssel\footnote{Ein Primärschlüssel ist ein Attribut zur eindeutigen Identifikation eines Datensatzes.} hinzugefügt.
