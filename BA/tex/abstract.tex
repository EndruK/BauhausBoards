...
%Um dies zu erproben wird zum Abschluss ein praktischer Testlauf durchgeführt und die Ergebisse ausgewertet.
%Für alle Nutzer im Raum wird eine eigene Inhaltsseite erzeugt, auf der diese individuelle Daten anzeigen lassen können.
%Zusätzlich ist es möglich, einen Status zu setzen, den 