...
\begin{figure}[h!]
  \centering
    \includepdf[page=1,scale=.8, pagecommand={}]{bauhausboards_how_to.pdf}
  \label{img:handbuch1}
\end{figure}
...
\begin{figure}[h!]
  \centering
    \includepdf[page=2,scale=.8, pagecommand={}]{bauhausboards_how_to.pdf}
  \label{img:handbuch2}
\end{figure}
\newpage
\begin{figure}[h!]
  \centering
    \includepdf[page=3,scale=.8, pagecommand={}]{bauhausboards_how_to.pdf}
  \label{img:handbuch3}
\end{figure}
\newpage
\begin{figure}[h!]
  \centering
    \includepdf[page=4,scale=.8, pagecommand={}]{bauhausboards_how_to.pdf}
  \label{img:handbuch4}
\end{figure}
\newpage
\begin{figure}[h!]
  \centering
    \includepdf[page=5,scale=.8, pagecommand={}]{bauhausboards_how_to.pdf}
  \label{img:handbuch5}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
