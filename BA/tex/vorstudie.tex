...
\\
Damit die Benutzer nicht mit den auf dem Gerät installierten Applikationen interagieren konnten, wurde eine Kiosk-Applikation\footurl{http://www.android-kiosk.com} installiert.
...
% Außerdem sollte es weniger als interaktives Whiteboard zu benutzen sein und mehr die Funktion von digitalen Pinnwänden übernehmen.
Es sollten nur noch die Besitzer die Möglichkeit haben, den angezeigten Inhalt zu ändern
% Dadurch sollten nur noch die Besitzer die Möglichkeit haben den Angezeigten Inhalt zu ändern.
