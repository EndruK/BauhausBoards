...
\section{Hermes}
Das Hermes System\cite{cheverest:2003} ist mit eine der ersten Versionen von interaktiven digitalen Türschildern. Es ist als Client-Server Applikation implementiert. Der Server wurde mit Java Servlets realisiert und generiert HTML Webseiten. Als Anzeigegeräte außerhalb der Büros wurden PDAs aufgehangen, welche per WLAN mit dem Server kommunizieren. Um die PDAs vor Diebstahl zu sichern wurde ein Aluminiumgehäuse entwurfen, welches zudem auch als Rahmen für den PDA funktioniert.
\section{NetBoards}
